...
public class TrackerAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView lvTrackImg = rowView.findViewById(R.id.lvTrackTargetImg);
        ...
        if(targetHit) {
            lvTrackImg.setImageResource(R.drawable.ic_check_lg);
            ...
            lvTrackImg.setImageResource(R.drawable.ic_x_lg);
